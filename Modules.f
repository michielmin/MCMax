...
c	parameter(gas2dust=100d0) ! Gijsexp, need it to be variable
	...
	real*8 lifetime,alphaturb,qturb,prandtl,f_ne,T_BG,maxthetaProDiMo,T_ISMdust
	...
	integer icoolingtime,qhp_solver,abun_in_name,nPAHrecompute,vistype
	real*8 HotGasMinRad,HotGasMaxRad,HotGasT,gammaUVdes,pfstop,tau_inc
!$OMP THREADPRIVATE(idum,xsn,ysn,zsn,tautot)
	...
	type Particle
		real*8 Nc,rv,rvmin,rvmax
		real*8,allocatable :: rho(:),rscale(:),mscale(:)
...
! parttype=6	Fits file particle
	...
	type Disk
		real*8 Tstar,Rstar,Lstar,Mstar,Tstar2,Rstar2,logg
